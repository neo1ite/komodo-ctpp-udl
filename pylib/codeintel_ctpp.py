...
# These keywords are copied from "CTPP-mainlex.udl" - be sure to keep both
# of them in sync.
keywords = [
    # Keywords
]
...
# lexers. You must define a Lexer class for lang CTPP. If Komodo's
# scintilla lexer for CTPP is UDL-based, then this is simply:
#
#   from codeintel2.udl import UDLLexer
#   class CTPPLexer(UDLLexer):
#       lang = lang
#
# Otherwise (the lexer for CTPP is one of Komodo's existing C++ lexers
...
#   class CTPPLexer(Lexer):
#       lang = lang
#       def __init__(self):
#           self._properties = SilverCity.PropertySet()
#           self._lexer = SilverCity.find_lexer_module_by_id(ScintillaConstants.SCLEX_CTPP)
#           self._keyword_lists = [
...
# CTPP content and returns a description of the code in that file.
# See "cile_ctpp.py" for more details.
#
# The CILE Driver is a class that calls this CILE. If CTPP is
