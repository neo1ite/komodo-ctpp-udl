# Registers the CTPP language in Komodo.

import logging
from koUDLLanguageBase import KoUDLLanguage

log = logging.getLogger("koCTPPLanguage")
#log.setLevel(logging.DEBUG)

def registerLanguage(registry):
    log.debug("Registering language CTPP")
    registry.registerLanguage(KoCTPPLanguage())

class KoCTPPLanguage(KoUDLLanguage):
    ...
    _reg_clsid_ = "{52c4544f-c84d-42ea-b003-663d1eb04799}"

    defaultExtension = '.ctpp'
